          ...
          <div className="flex items-center justify-between">
            <div className="space-y-2">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-4xl font-bold tracking-tight">Gestion de la Facturation</h1>
                  <p className="text-purple-100 text-lg mt-1">Gérez vos commandes clients</p>
                </div>
              </div>
            </div>
