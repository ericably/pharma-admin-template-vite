          ...
          <div className="flex items-center justify-between">
            <div className="space-y-1">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h1 className="text-2xl font-bold tracking-tight">Gestion des Ordonnances</h1>
                  <p className="text-purple-100 text-sm">Créer, préparer et gérer les ordonnances</p>
                </div>
              </div>
            </div>
            <div className="text-right space-y-1">
              <div className="text-purple-100 text-xs">Total Ordonnances</div>
      ...
      <div className="grid gap-3 grid-cols-1 md:grid-cols-4">
        <Card className="bg-gradient-to-br from-emerald-500 to-emerald-600 text-white border-0 shadow-lg hover:shadow-xl transition-all duration-300">
          ...
          <CardContent className="pt-0">
            ...
            <p className="text-emerald-100 text-sm">Ordonnances</p>
          </CardContent>
        </Card>
